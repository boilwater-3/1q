...
SarProductDebugView SarProductDebugViewBuilder::Build(const SarCycleInput& input,
  ...
  view.output_cycle_index = result.product.output_frame.cycle_index;
  ...
  view.completed_stage = result.product.output_frame.completed_stage;
  view.has_raw_echo = result.product.output_frame.has_raw_echo;
  view.has_range_compressed_echo = result.product.output_frame.has_range_compressed_echo;
  view.has_l1_image = result.product.output_frame.has_l1_image;
  view.has_l3_bp_image = result.product.output_frame.has_l3_bp_image;
  view.has_focused_pixels =
      !result.product.focused_image.real_values.empty() || !result.product.focused_image.imaginary_values.empty();
  view.estimated_snr_db = result.product.output_frame.estimated_snr_db;
  view.range_sample_count = result.product.output_frame.range_sample_count;
  view.azimuth_pulse_count = result.product.output_frame.azimuth_pulse_count;
