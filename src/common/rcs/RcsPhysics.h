...
/**
 * @brief REOS 对齐入口：初始化树体散射器（AVX 版本标识保留）。
 */
TreeScattererState InitTreeScatterer_AVX(const TreeScattererConfig& config);

/**
 * @brief REOS 对齐入口：叶片参数方程批量计算（ymm8r4 标识保留）。
