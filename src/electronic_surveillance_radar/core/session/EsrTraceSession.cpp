...
Json BuildJson(const common::EsrPoseState& value) {
  Json json;
...
Json BuildJson(const common::EmitterBeamState& value) {
  Json json;
...
Json BuildJson(const common::EmitterTruthState& value) {
  Json json;
...
Json BuildJson(const core::context::EsrCycleInput& value) {
  Json json;
  json["cycle_index"] = value.cycle_index;
  json["dt_sec"] = value.dt_sec;
  json["platform_pose"] = BuildJson(value.platform_pose);
  json["scene_emitters"] =
      SerializeArray(value.scene_emitters, [](const common::EmitterTruthState& emitter) {
...
Json BuildJson(const core::context::EsrValidationIssue& value) {
  Json json;
...
Json BuildJson(const common::EmitterObservation& value) {
  Json json;
...
Json BuildJson(const common::EmitterHypothesis& value) {
  Json json;
...
Json BuildJson(const common::TruthAssociationRecord& value) {
  Json json;
  json["observation_id"] = value.observation_id;
...
Json BuildJson(const common::EsrOutputFrame& value) {
  Json json;
  ...
  observation_output["observations"] = SerializeArray(
      ...
      [](const common::EmitterObservation& observation) { return BuildJson(observation); });
  ...
  emitter_output["hypotheses"] = SerializeArray(
      ...
      [](const common::EmitterHypothesis& hypothesis) { return BuildJson(hypothesis); });
  ...
  truth_output["associations"] = SerializeArray(
      ...
      [](const common::TruthAssociationRecord& association) { return BuildJson(association); });
  json["truth_evaluation_output"] = truth_output;

  return json;
}

Json BuildJson(const pipeline::InterceptPipelineConfig& value) {
  Json json;
...
Json BuildJson(const core::session::EsrSessionConfig& value) {
  Json json;
...
Json BuildJson(const core::session::EsrCycleResult& value) {
  Json json;
  json["output_frame"] = BuildJson(value.output_frame);
  json["validation_issues"] =
      SerializeArray(value.validation_issues, [](const core::context::EsrValidationIssue& issue) {
...
Json BuildJson(const core::session::EsrRuntimeConfigPatch& value) {
  Json json;
