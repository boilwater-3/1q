...
const EnvironmentSceneState& SceneManager::GetPendingScene() const {
  return pending_scene_;
}

EnvironmentSceneState* SceneManager::MutablePendingScene() {
  return &pending_scene_;
}
...
const EnvironmentSceneState& SceneManager::GetActiveScene() const {
