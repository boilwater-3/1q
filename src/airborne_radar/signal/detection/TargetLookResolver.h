...
class TargetLookResolver {
 public:
   ...
   */
  static TargetLookAnglesDeg Resolve(const session::RadarSceneTarget& target) {
    ...
    const float horizontal_norm = std::sqrt(position_x * position_x + position_y * position_y);
