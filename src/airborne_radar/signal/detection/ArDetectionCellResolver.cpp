...
oneq::common::radar::DetectionCellConfig ToCommon(const ArDetectionCellConfig& config) {
  ...
  out.enable_anti_rgpo_leading_edge = config.enable_anti_rgpo_leading_edge;
...
oneq::common::radar::DetectionCellTarget ToCommon(const ArDetectionCellTarget& target) {
...
void FromCommon(const oneq::common::radar::DetectionCellResult& in, ArDetectionCellResult* out) {
