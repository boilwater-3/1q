...
KalmanPredictor::KalmanPredictor(KalmanPredictorConfig config) : config_(config) {}

GaussianTrackState KalmanPredictor::Predict(const GaussianTrackState& prior, float dt) const {
...
void KalmanPredictor::UpdateConfig(KalmanPredictorConfig config) { config_ = config; }
