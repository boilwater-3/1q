...
EventToken CycleEventBus::SubscribeImpl(std::type_index type,
...
void CycleEventBus::BeginCycle() { std::swap(current_queue_index_, next_queue_index_); }

void CycleEventBus::DispatchCurrentCycle() { queues_[CurrentQueueIndex()].process(); }
