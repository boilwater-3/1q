...
#ifndef AIRBORNE_RADAR_RECOGNITION_RANGE_PROFILE_FEATURE_EXTRACTOR_H_
#define AIRBORNE_RADAR_RECOGNITION_RANGE_PROFILE_FEATURE_EXTRACTOR_H_
...
/**
 * @brief RangeProfileFeatureExtractor 从距离向散射列表构造效能化距离像观测。
 *
 ...
 * 要求时维度整体无效。
 */
class RangeProfileFeatureExtractor {
 public:
  /**
   * @brief 提取距离像特征观测。
   ...
   */
  static RangeProfileObservation Extract(
      const std::vector<session::RangeRcsScatterer>& scatterers, float bandwidth_hz, float snr_db,
...
#endif  // AIRBORNE_RADAR_RECOGNITION_RANGE_PROFILE_FEATURE_EXTRACTOR_H_
