...
/**
 * @brief RecognitionMatchResult 匹配结果：候选排序、大类分数与可分性。
 */
struct RecognitionMatchResult {
  bool has_candidates{false};  /**< 是否有任何模型参与匹配。 */
  std::vector<RecognitionCandidate> candidates{}; /**< 按得分降序。 */
...
/**
 * @brief RecognitionMatcher 将单周期特征观测与数据库模板比对。
 *
...
class RecognitionMatcher {
 public:
   ...
   */
  static RecognitionMatchResult QueryBestMatch(
...
#endif  // AIRBORNE_RADAR_RECOGNITION_RECOGNITION_MATCHER_H_
