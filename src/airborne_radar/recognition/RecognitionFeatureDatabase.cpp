...
bool ReadTemplateColumnPair(sqlite3_stmt* stmt, int mean_column, int std_column,
                            const std::string& path, RecognitionFeatureTemplate* out,
...
bool ReadRcsTemplate(sqlite3_stmt* stmt, const std::string& path,
                     RecognitionModelProfile* profile, std::string* error) {
  RecognitionFeatureTemplate mean_std;
...
bool RecognitionFeatureDatabase::Load(const std::string& path, RecognitionFeatureDatabase* database,
  ...
  const auto load_template_table =
      [&](const char* table, const char* select_sql,
          bool (*reader)(sqlite3_stmt*, const std::string&, RecognitionModelProfile*,
                         std::string*)) -> bool {
    sqlite3_stmt* stmt = nullptr;
