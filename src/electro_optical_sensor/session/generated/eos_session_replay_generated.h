...
struct EosHardwareConfigT : public flatbuffers::NativeTable {
  ...
  float detector_detectivity_cm_sqrt_hz_per_w;
  float detector_area_cm2;
  float min_detection_depression_deg;
  float max_detection_depression_deg;
  EosHardwareConfigT()
      : wavelength_lower_um(0.0f),
        wavelength_upper_um(0.0f),
        optical_aperture_m(0.0f),
        focal_length_m(0.0f),
        detector_detectivity_cm_sqrt_hz_per_w(0.0f),
        detector_area_cm2(0.0f),
        min_detection_depression_deg(0.0f),
        max_detection_depression_deg(0.0f) {
  }
};
...
struct EosRuntimeConfigPatchT : public flatbuffers::NativeTable {
  ...
  std::unique_ptr<eos::replay::EosEnvironmentConfigT> environment;
  bool has_scenario_config_in_environment;
  bool has_work_mode;
  int32_t work_mode;
  ...
  EosRuntimeConfigPatchT()
      : has_mission(false),
        ...
        has_scenario_config_in_environment(false),
        has_work_mode(false),
        work_mode(0),
...
struct EosRuntimeConfigPatch FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_FRAME_RATE_HZ = 28,
    VT_HAS_SENSOR_ENABLED = 30,
    VT_SENSOR_ENABLED = 32
  };
...
struct EosRuntimeConfigPatchBuilder {
  ...
  void add_has_sensor_enabled(bool has_sensor_enabled) {
    fbb_.AddElement<uint8_t>(EosRuntimeConfigPatch::VT_HAS_SENSOR_ENABLED, static_cast<uint8_t>(has_sensor_enabled), 0);
  }
  void add_sensor_enabled(bool sensor_enabled) {
    fbb_.AddElement<uint8_t>(EosRuntimeConfigPatch::VT_SENSOR_ENABLED, static_cast<uint8_t>(sensor_enabled), 0);
  }
...
inline void EosHardwareConfig::UnPackTo(EosHardwareConfigT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = detector_detectivity_cm_sqrt_hz_per_w(); _o->detector_detectivity_cm_sqrt_hz_per_w = _e; }
  { auto _e = detector_area_cm2(); _o->detector_area_cm2 = _e; }
  { auto _e = min_detection_depression_deg(); _o->min_detection_depression_deg = _e; }
  { auto _e = max_detection_depression_deg(); _o->max_detection_depression_deg = _e; }
}
...
inline flatbuffers::Offset<EosHardwareConfig> CreateEosHardwareConfig(flatbuffers::FlatBufferBuilder &_fbb, const EosHardwareConfigT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _detector_detectivity_cm_sqrt_hz_per_w = _o->detector_detectivity_cm_sqrt_hz_per_w;
  auto _detector_area_cm2 = _o->detector_area_cm2;
  auto _min_detection_depression_deg = _o->min_detection_depression_deg;
  auto _max_detection_depression_deg = _o->max_detection_depression_deg;
  return eos::replay::CreateEosHardwareConfig(
      ...
      _optical_aperture_m,
      _focal_length_m,
      _detector_detectivity_cm_sqrt_hz_per_w,
      _detector_area_cm2,
      _min_detection_depression_deg,
      _max_detection_depression_deg);
}
...
inline void EosRuntimeConfigPatch::UnPackTo(EosRuntimeConfigPatchT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = environment(); if (_e) _o->environment = std::unique_ptr<eos::replay::EosEnvironmentConfigT>(_e->UnPack(_resolver)); }
  { auto _e = has_scenario_config_in_environment(); _o->has_scenario_config_in_environment = _e; }
...
inline flatbuffers::Offset<EosRuntimeConfigPatch> CreateEosRuntimeConfigPatch(flatbuffers::FlatBufferBuilder &_fbb, const EosRuntimeConfigPatchT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _environment = _o->environment ? CreateEosEnvironmentConfig(_fbb, _o->environment.get(), _rehasher) : 0;
  auto _has_scenario_config_in_environment = _o->has_scenario_config_in_environment;
  ...
  return eos::replay::CreateEosRuntimeConfigPatch(
      ...
      _has_environment,
      _environment,
      _has_scenario_config_in_environment,
      _has_work_mode,
      _work_mode,
