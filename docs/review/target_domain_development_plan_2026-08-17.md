...
Status: final
Date: 2026-08-17
Completed: 2026-08-17（P1-P5 交付完成；P0 残留=TARGET-OQ-3 需求方签认，见 §2）
...
> 见 §1。P0 的需求方指标签认仍未闭环（TARGET-OQ-3 open），残留清单见 §2。
...
| 阶段 | 名称 | 状态 | 证据 |
|---|---|---|---|
| P0 | 需求基线与证据矩阵 | 证据已落地；**需求方指标签认未闭环**（TARGET-OQ-3 open） | 决策记录 §4/§5：OQ-3 语义差实测 + 可达性矩阵实测（地板公里级；σ=5 µrad 触 float 精度边缘）；签认表已填数字 |
...
| 项 | 状态 | 载体 |
|---|---|---|
| P0 需求方指标签认 + TARGET-OQ-3 正式冻结 | open | `docs/common/open_questions.md` TARGET-OQ-3 |
...
| Sensor-like 共模偏差项 R 建模 | 后续 | 同上（待 TARGET-OQ-3 签认口径） |
