...
/// EOS 探测距离窗 ≈ [11.5, 22.9] km（min/max 探测俯仰角 2°/1°），目标
/// 斜距全程稳定在窗内（起飞爬升期平台高度不足、窗口窄，探测从爬升后期
/// 开始）。
...
const ScriptedTarget kTargetScript[] = {
    {90.0, 12000.0, 40.0, 5.0, 520.0, 2.2f, 18.0f},
    {90.0, 14000.0, 38.0, -5.0, 540.0, 1.4f, 15.0f},
};
