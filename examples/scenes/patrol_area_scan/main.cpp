/**
 * @file patrol_area_scan/main.cpp
 * @brief 场景 patrol_area_scan 可执行薄入口：场景 JSON 由编译宏钉死，共用 RunScene。
 *
 * 调试参数 --cycles/--view-every/--output-dir（见 app/runner.h）；本目录
 * patrol_area_scan.json 为场景描述、patrol_area_scan.md 为期望表。任意场景通用 runner：
