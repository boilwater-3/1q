...
inline void BeginRfWorldCycle(AppSceneState* scene, double window_duration_sec) {
  if (scene == nullptr) {
    return;
  }
  scene->rf_world = {};
...
inline void PublishEquipmentEmissions(AppSceneState* scene,
