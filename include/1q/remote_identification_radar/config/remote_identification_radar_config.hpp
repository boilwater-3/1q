...
#ifndef ONEQ_REMOTE_IDENTIFICATION_RADAR_CONFIG_REMOTE_IDENTIFICATION_RADAR_CONFIG_HPP_
#define ONEQ_REMOTE_IDENTIFICATION_RADAR_CONFIG_REMOTE_IDENTIFICATION_RADAR_CONFIG_HPP_
