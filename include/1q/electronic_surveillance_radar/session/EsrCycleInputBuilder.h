/**
 * @file EsrCycleInputBuilder.h
 * @brief 一步法构建 EsrCycleInput，封装 ExternalInputAdapter 的两步调用。
 */

#ifndef ONEQ_ELECTRONIC_SURVEILLANCE_RADAR_SESSION_ESR_CYCLE_INPUT_BUILDER_H_
#define ONEQ_ELECTRONIC_SURVEILLANCE_RADAR_SESSION_ESR_CYCLE_INPUT_BUILDER_H_
 ...
 */
struct ONEQ_API EsrCycleInputBuilder {
  /**
 ...
 private:
  EsrCycleInputBuilder() = delete;
};

}  // namespace session
}  // namespace electronic_surveillance_radar

#endif  // ONEQ_ELECTRONIC_SURVEILLANCE_RADAR_SESSION_ESR_CYCLE_INPUT_BUILDER_H_
