...
#ifndef ONEQ_ELECTRONIC_SURVEILLANCE_RADAR_EXTENSION_I_INTERCEPT_PIPELINE_H_
#define ONEQ_ELECTRONIC_SURVEILLANCE_RADAR_EXTENSION_I_INTERCEPT_PIPELINE_H_
...
#endif  // ONEQ_ELECTRONIC_SURVEILLANCE_RADAR_EXTENSION_I_INTERCEPT_PIPELINE_H_
