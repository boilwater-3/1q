...
#ifndef ELECTRONIC_SURVEILLANCE_RADAR_COMMON_EMITTER_TRUTH_STATE_H_
#define ELECTRONIC_SURVEILLANCE_RADAR_COMMON_EMITTER_TRUTH_STATE_H_
...
#endif  // ELECTRONIC_SURVEILLANCE_RADAR_COMMON_EMITTER_TRUTH_STATE_H_
