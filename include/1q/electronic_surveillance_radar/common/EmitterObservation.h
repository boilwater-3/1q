...
#ifndef ELECTRONIC_SURVEILLANCE_RADAR_COMMON_EMITTER_OBSERVATION_H_
#define ELECTRONIC_SURVEILLANCE_RADAR_COMMON_EMITTER_OBSERVATION_H_
...
#endif  // ELECTRONIC_SURVEILLANCE_RADAR_COMMON_EMITTER_OBSERVATION_H_
