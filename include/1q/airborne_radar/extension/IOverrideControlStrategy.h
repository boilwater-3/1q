...
#ifndef ONEQ_AIRBORNE_RADAR_EXTENSION_I_OVERRIDE_CONTROL_STRATEGY_H_
#define ONEQ_AIRBORNE_RADAR_EXTENSION_I_OVERRIDE_CONTROL_STRATEGY_H_
...
#endif  // ONEQ_AIRBORNE_RADAR_EXTENSION_I_OVERRIDE_CONTROL_STRATEGY_H_
