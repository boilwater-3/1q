...
#ifndef ONEQ_AIRBORNE_RADAR_EXTENSION_CONTROL_CONTROL_DIRECTIVE_H_
#define ONEQ_AIRBORNE_RADAR_EXTENSION_CONTROL_CONTROL_DIRECTIVE_H_
...
#endif  // ONEQ_AIRBORNE_RADAR_EXTENSION_CONTROL_CONTROL_DIRECTIVE_H_
