...
#ifndef AIRBORNE_RADAR_CORE_SESSION_RADAR_SESSION_CONFIG_PRESETS_H_
#define AIRBORNE_RADAR_CORE_SESSION_RADAR_SESSION_CONFIG_PRESETS_H_
...
using signal::config::SignalPipelineConfig;
...
#endif  // AIRBORNE_RADAR_CORE_SESSION_RADAR_SESSION_CONFIG_PRESETS_H_
