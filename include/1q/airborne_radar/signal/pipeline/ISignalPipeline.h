...
class ONEQ_API ISignalPipeline {
 public:
   ...
   */
  virtual SignalCycleResult RunCycle(const common::model::TargetFeatureList& input_state,
   ...
   */
  virtual void SetControlProfile(const common::control::RadarControlProfile& control_profile) = 0;
