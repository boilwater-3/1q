/**
 * @file electro_optical_sensor_environment.hpp
 * @brief EOS 环境层统一入口。
 */

#ifndef ONEQ_ELECTRO_OPTICAL_SENSOR_ENVIRONMENT_ELECTRO_OPTICAL_SENSOR_ENVIRONMENT_HPP_
#define ONEQ_ELECTRO_OPTICAL_SENSOR_ENVIRONMENT_ELECTRO_OPTICAL_SENSOR_ENVIRONMENT_HPP_
