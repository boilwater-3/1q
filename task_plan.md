...
| 10 | Phase 2B 小场景 GBP 与跨算法比较 | in_progress | GBP 尺寸门、相位重参考、RDA/GBP 对比通过 |
| 11 | Phase 2C 扩展审批门 | pending | 基于双算法证据决定 Auto 或 L2 运动补偿 |
...
执行阶段 10：冻结 GBP 坐标、相位、尺寸和性能契约，实现严格 `128x128` 门禁下的最小小场景 GBP，并使用统一指标与 RDA 比较。
