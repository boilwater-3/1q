...
| 57 | 辐射定标闭环工程契约 | pending | 冻结测试侧定标、RCS 反演与多点融合口径 |
...
1. 冻结标定目标、定标常数和绝对 RCS 反演公式。
2. 冻结多点标定融合、无效输入和数值容差。
3. 冻结首批无噪声及受控联合干扰验收矩阵。
4. 明确测试侧/内部实现边界，public API、Session 和 replay 继续后置。
