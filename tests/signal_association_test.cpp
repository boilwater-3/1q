...
TEST(DataAssociationEngineTest, KeepsStableAssociationAcrossCycles) {
  ...
  const common::TargetFeatureList cycle_2{MakePositionTarget(11.0f, 0.0f, 0.0f),
...
TEST(DataAssociationEngineTest, StatelessWithoutSeedsMakesAssociationAcrossCyclesIndependent) {
  ...
  const common::TargetFeatureList cycle_2{MakePositionTarget(10.5f, 0.0f, 0.0f)};
...
TEST(DataAssociationEngineTest, HandlesCrossedMeasurementsByCostMinimization) {
  ...
  const common::TargetFeatureList cycle_1{MakePositionTarget(20.0f, 0.0f, 0.0f),
  ...
  const common::TargetFeatureList cycle_2{MakePositionTarget(201.0f, 0.0f, 0.0f),
...
TEST(DataAssociationEngineTest, UsesCartesianPositionByDefaultWhenPositionAvailable) {
  ...
  const common::TargetFeatureList cycle_2{MakePositionTarget(101.0f, 0.0f, 0.0f),
...
TEST(DataAssociationEngineTest, DetectedTargetMissingPositionFailsFast) {
  ...
  const common::TargetFeatureList cycle_1{MakeTarget(100.0f, 2.0f), MakeTarget(220.0f, 5.0f)};
  const std::vector<std::uint8_t> detected_1{1U, 1U};
