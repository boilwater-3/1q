...
set(_fd_test_executable "${PROJECT_NAME}_flight_dynamic_unit_tests")
...
add_test(NAME "fd_smoke::1q_fd_tests"
         COMMAND ${_fd_test_executable} --gtest_filter=${_fd_smoke_filter_str})
...
add_test(NAME "fd_contract::1q_fd_tests"
         COMMAND ${_fd_test_executable} --gtest_filter=${_fd_contract_filter_str})
...
add_test(NAME "fd_controllability::1q_fd_tests"
         COMMAND ${_fd_test_executable} --gtest_filter=${_fd_ctrl_filter_str})
...
add_test(NAME "fd_performance::1q_fd_tests"
         COMMAND ${_fd_test_executable} --gtest_filter=${_fd_perf_filter_str})
...
add_test(NAME "fd_known_limit::1q_fd_tests"
         COMMAND ${_fd_test_executable} --gtest_filter=${_fd_limit_filter_str})
set_tests_properties("fd_known_limit::1q_fd_tests" PROPERTIES LABELS "fd_known_limit")

# The FD partition owns JSBSim include/link/data-root wiring in
# partitions/Unit.cmake. This file only retains the Phase 2 compatibility
# CTest tiers and must not mutate the aggregate 1q_fd_tests build target.
