...
config::execution::EosInternalExecutionConfig MakeConfig(bool enable_straylight_filter) {
  ...
  config.scan.scan_start_az_deg = 170.0f;
  config.scan.scan_end_az_deg = 190.0f;
  config.scan.scan_center_el_deg = 45.0f;
  config.scan.scan_rate_deg_per_sec = 10.0f;
  config.scan.horizontal_fov_deg = 20.0f;
  config.scan.vertical_fov_deg = 20.0f;
  config.stray_light.enable_straylight_filter = enable_straylight_filter;
  config.stray_light.hood_inner_half_angle_deg = 8.0f;
  config.stray_light.hood_outer_half_angle_deg = 70.0f;
  config.stray_light.hood_min_suppression_ratio = 0.2f;
  config.stray_light.hood_max_suppression_ratio = 0.9f;
  return config;
}
