...
TEST(EsrCycleInputBuilderTest, BuilderMatchesTwoStepAdapter) {
  ...
  oneq::foundation::LlaCoordinateDegM emitter_lla = origin_lla;
  ...
  pose_input.platform_velocity_mps.x = 100.0f;
  pose_input.platform_velocity_mps.y = 50.0f;
  pose_input.platform_velocity_mps.z = 20.0f;
  ...
  ext_emitter.emitter_velocity_mps.x = 100.0f;
  ext_emitter.emitter_velocity_mps.y = 50.0f;
  ext_emitter.emitter_velocity_mps.z = 20.0f;
