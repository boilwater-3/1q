...
class DummyInterceptPipeline : public extension::IInterceptPipeline {
 public:
  ...
  void UpdateConfig(extension::InterceptPipelineConfig config) override { config_ = config; }
...
int main() {
  ...
  electronic_surveillance_radar::extension::EsrController controller(pipeline,
                                                                            environment_service);
  ...
  electronic_surveillance_radar::extension::IInterceptPipeline& pipeline_ref =
