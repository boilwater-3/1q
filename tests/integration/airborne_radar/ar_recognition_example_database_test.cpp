...
using recognition::RecognitionModel;
...
const RecognitionModel* FindModel(const RecognitionFeatureDatabase& database,
...
TEST(RecognitionExampleDatabaseTest, LoadsCommittedExampleDatabase) {
  ...
  const RecognitionModel* f16 = FindModel(database, "F-16C");
  ...
  const RecognitionModel* b52 = FindModel(database, "B-52H");
  ...
  const RecognitionModel* bgm109 = FindModel(database, "BGM-109");
  ...
  const RecognitionModel* mq9 = FindModel(database, "MQ-9A");
